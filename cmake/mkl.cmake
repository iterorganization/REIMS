...
if(WIN32)
   ...
   set(_mkl_intel_lp64 mkl_intel_lp64)
   set(_mkl_core mkl_core)
   set(_mkl_sequential mkl_sequential)
   set(_mkl_intel_thread mkl_intel_thread)
   set(_mkl_tbb_thread mkl_tbb_thread)
   set(_libiomp5md "")
   set(_tbb_lib tbb)
endif()
